...
/*   Updated: 31/08/2019 00:35:47 by Snkh                               */
/*                                                                      */
                ...
                <div class="modal-body" id="newsletter_modal_content">
                    <form method="post" data-ajax="true" action="<?= $this->Html->url(array('controller' => 'qatanews', 'action' => 'user_subscribe')) ?>">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary btn-large" onclick="setTimeout(function() {$('#newsletter_modal').modal('hide');}, 2000);"><?= $Lang->get("GLOBAL__SUBMIT") ?></button>
                        </div>
                    </form>
                </div>
            </div>
